...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white p-4 sm:p-6">
      {/* Header with centered title and right login button */}
      <div className="relative flex justify-center items-center mb-6">
  {/* Centered Title */}
  <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-blue-400 text-center">
    📌 Location Based To-Do List
  </h1>

  {/* Login Button - Right Corner */}
  <button className="absolute right-0 top-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 transition px-5 py-2 rounded-full shadow-lg text-white font-semibold">
    🔐 Login
  </button>
</div>
      ...
      <div className="flex flex-wrap gap-3 justify-center mb-6">
        <input
          ...
          onChange={(e) => setNewTask(e.target.value)}
          placeholder="Enter task name"
          className="px-4 py-2 rounded-lg text-white bg-white/10 backdrop-blur border border-white/20 w-full sm:w-64"
        />
        <button
          onClick={handleAddTask}
          className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg flex items-center gap-2"
